...
<div class="container clearboth">
        ...
        <header>
            ...
            <div class="header_c">
                <form id="index_submit">
                    <div class="header_c_div"><span>半自助</span><img src="/harmony/images/search_select_sj.png"></div>
    ...
    <div class="teamTrip clearboth">
        <div class="teamTrip_nav">
            ...
            <div><a id="productlist" href="javascript:void(0)">半自助</a> </div>
            <div class="site_kh"> > </div>
